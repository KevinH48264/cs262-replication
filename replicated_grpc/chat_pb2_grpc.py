...
class ChatService(object):
    ...
    def SendHeartbeat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ChatService/SendHeartbeat',
            chat__pb2.Request.SerializeToString,
            chat__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ReplicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateAccount = channel.unary_unary(
                '/ReplicationService/UpdateAccount',
                request_serializer=chat__pb2.AccountUpdate.SerializeToString,
                response_deserializer=chat__pb2.Response.FromString,
                )
        self.UpdateQueue = channel.unary_unary(
                '/ReplicationService/UpdateQueue',
                request_serializer=chat__pb2.QueueUpdate.SerializeToString,
                response_deserializer=chat__pb2.Response.FromString,
                )
...
def add_ReplicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateAccount': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=chat__pb2.AccountUpdate.FromString,
                    response_serializer=chat__pb2.Response.SerializeToString,
            ),
            'UpdateQueue': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateQueue,
                    request_deserializer=chat__pb2.QueueUpdate.FromString,
                    response_serializer=chat__pb2.Response.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ReplicationService(object):
    ...
    def UpdateAccount(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ReplicationService/UpdateAccount',
            chat__pb2.AccountUpdate.SerializeToString,
            chat__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateQueue(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ReplicationService/UpdateQueue',
            chat__pb2.QueueUpdate.SerializeToString,
            chat__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
